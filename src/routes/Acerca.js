        ...
        <div className='container' >
            ...
            <div className='row mt-5 justify-content-center'>
              <div className='col-10 col-md-8 '>
                <h2 className='lila mt-35 mt-md-20 f-md-3'>Acerca de este proyecto</h2>
                <p className='mt-5 fw-100 lh1-5' >
                ...
                <p className='fw-100 lh1-5 mt-10 f1 pb-5'>
            ...
            {/* <div className='col-10 mt-md-20 col-md-6 pl-md-10 fw-100 lh1-5'>
                <div className='mb-2'>
                  <p><b>quien</b></p>
                  <p>Alguien</p>
                  <p>Alguien</p>
