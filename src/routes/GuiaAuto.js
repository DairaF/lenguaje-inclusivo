  ...
  return (
    <div className='guias'>
      ...
      <div className='row justify-content-center text-center pb-5'>
        <h2 className='col-10 col-md-8 col-md-4 mt-45 mt-md-25'><b>Guía de <span className='playfairItalic'>autorevisión</span> a la hora de <span className='playfairItalic'>escribir</span></b></h2>
      </div>
      <div className='row justify-content-center text-center pb-5'>
      ...
      <div className='row justify-content-center pb-5 px-5'>
              {
