    ...
    <div className="App bg-crema">
      <div className='container'>
        ...
        <div id="texto" className=' bg-gris'>
          ...
          <div className="row">
            <a className="" href="/que-sentido-tiene-el-lenguaje-inclusivo"><h2 className="col-9 mt-3 mx-auto text-center  lila pb-5">¿Qué <span className='playfairItalic'>sentido</span> tiene el lenguaje inclusivo?</h2></a>
