  ...
  useEffect(()=>{
    ...
    <div className="App bg-crema">
      <div className='container'>
        <div id="landing1">
          ...
          <div className="row justify-content-center">
            ...
            <AnimationOnScroll animateIn="animate__slideInDown">
              ...
              <p id="bajada" className="playfair mt-5">Un experimento para  <span className='under-lila'>hacer <span className='aktive'>consciente</span> eso que hacemos muchas veces sin pensar:<span className='playfairItalic'> hablar</span></span></p>
            </div>
          </div>
        </div>
        ...
        <div className='row'><img style={{ transform: `translateY(-${offsetY / 5}px)` }} id="home3" className='col-10' src={require("../assets/img/illus/home3.png")} /><span style={{ transform: `translateY(-${offsetY * 0.8}px)` }} className='col-2 mt-25 blanco f5'>X</span></div>
        <div className='landing2'>
          ...
          <div className="row">
            <span className='nota playfair offset-3 col-4 opacity-05 negro'><span className='bg-white'>El feminismo</span> es un movimiento político y social, una teoría política y una perspectiva filosófica</span>
        ...
        <div id="landing3">
          <div className="row">
            <br/>
            <span style={{ transform: `translateY(-${offsetY * 0.3}px)` }} className='mt-25 nota playfair offset-3 col-4 opacity-05 negro'>Facultad del ser humano de expresarse y comunicarse con los demás</span>
            <div style={{ transform: `translateY(-${offsetY * 0.3}px)` }} className='offset-4 mt-2 col-4'><img className='linea' src={require('../assets/img/linea.png')} /></div>
            <p style={{ transform: `translateY(-${offsetY * 0.3}px)` }} id="lenguaje" className="col-9 mt-2 mx-auto text-center playfair"> El <span className='lila bg-blanco aktiv'>lenguaje</span> no solo representa la realidad: la construye
        ...
        <div id="quiz" className='bg-negro blanco'>
          ...
          <div className="row justify-content-center">
            <a href="/quiz"><h2 className="col-9 col-md-4 mt-5 mx-auto text-center ">Descubrí tu propio lenguaje <span className='playfairItalic under-lila pb-2'>inclusivo</span></h2></a>
          </div>
          </AnimationOnScroll>
          <div className="row justify-content-center">
          ...
          <div className="row">  
            <a className="col-12 mt-5 mx-auto text-center playfair" href="/quiz"><img alt="." className="logo" src={require("../assets/img/flechaBlanca.png")}/></a>
          </div>
        </div>
        ...
        <div id="caja" className='bg-lila'>
          ...
          <AnimationOnScroll animateIn="animate__pulse">
          <div className="row justify-content-center">
            <a href="/caja-de-herramientas"><h2 className="col-9 col-md-4 mt-5 mx-auto text-center blanco under-negro pb-5">Caja de <span className='playfairItalic'>herramientas</span></h2></a>
          </div>
          </AnimationOnScroll>
          <div className="row justify-content-center">
          ...
          <div className='row'>  
            <a className="col-12 mt-5 mx-auto text-center playfair" href="/caja-de-herramientas"><img alt="." className="logo" src={require("../assets/img/flechaBlanca.png")}/></a>
          </div>
        </div>
        {/* TEXTO EXPOSITIVO */}
        <div id="texto" className=' bg-gris'>
          <div className="row">
            <span className="mt-25 mt-md-15 mx-auto text-center bg-negro py-1 f06 col-4 col-md-2 blanco">RECURSOS</span>
          </div>
          <div className="row">
            <AnimationOnScroll animateIn="animate__pulse">
            <a className="" href="/texto-expositivo"><h2 className="col-9 mt-5 mx-auto text-center blanco under-negro pb-5">¿Qué <span className='playfairItalic'>sentido</span> tiene el lenguaje inclusivo?</h2></a>
            </AnimationOnScroll>
          ...
          <div className='row'>  
            <a className="col-12 mt-5 mx-auto text-center playfair" href="/texto-expositivo"><img alt="." className="logo" src={require("../assets/img/flechaBlanca.png")}/></a>
          </div>
        </div>
      </div>
    </div>
